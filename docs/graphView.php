...
<body>
    ...
    paramRefreshTime = (paramRefreshTime != null) ? parseInt(paramRefreshTime) : 1000;
    paramMaxDataDisplay = (paramMaxDataDisplay != null) ? parseInt(paramMaxDataDisplay) : 10;
    paramPointRadius = (paramPointRadius != null) ? parseInt(paramPointRadius) : 2;
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // console.debug("refresh interval: ", paramRefreshTime, "ms");
        update();
